 ...
 * @author Dennys
 */
public class PanelTarjetaDeCredito extends javax.swing.JPanel {

    /**
     * Creates new form NewJPanel
     */
    public PanelTarjetaDeCredito() {
        initComponents();
        limitarDatos();
    }
    
    public void limitarDatos(){
        lblHoraActual.setText(UtilidadesVista.obtenerHoraActual());
        lblDateActual.setText(UtilidadesVista.obtenerFechaActual());
        UtilidadesVista.permitirSoloNumTxt(txtNumeroTarjeta);
        UtilidadesVista.limitarTamanioTxt(txtNumeroTarjeta, 12);
        UtilidadesVista.permitirSoloLetrasTxt(txtNombreTitular);
        UtilidadesVista.limitarTamanioTxt(txtCVC, 4);
        UtilidadesVista.permitirSoloNumTxt(txtCVC);
    }
    /**
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addComponent(FechaExpiracion, javax.swing.GroupLayout.DEFAULT_SIZE, 149, Short.MAX_VALUE))))))
