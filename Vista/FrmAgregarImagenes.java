 ...
 * @author lettc
 */
public class FrmAgregarImagenes extends javax.swing.JFrame {

    /**
     * Creates new form FrmAgregarImagenes
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmAgregarImagenes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmAgregarImagenes().setVisible(true);
            }
        });
    }
